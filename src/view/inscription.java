	...
	public GridPane makeBottom()
	{
		GridPane bas = new GridPane();
	          ...
	          try {
				...
				bas.add(makeBlock("Mensualités partielles :",String.valueOf(db.MensualitesPartielles()),"white","#215060"), 3, 2);
				
				bas.add(makeBlock("Pas en règle :",String.valueOf(new facturedb().getNotPaid(new SimpleDateFormat("M").format(new Date())).size()),"#215060","white"), 4, 2);
...

{
	...
	public void run() {
		// TODO Auto-generated method stub
		if(typePaiement.equals("mensualité"))
		{
